...
\begin{figure}[h]
\centering
\subfigure[Canny Edges]{\label{fig:a}\includegraphics[scale=0.6]{canny_edges}}
\subfigure[Filled Canny Edges]{\label{fig:b}\includegraphics[scale=0.6]{canny_filled}}
\caption{Canny edges.}
\end{figure}
\\
